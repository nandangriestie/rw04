...
<head>
    ...
    <title>RW04-Antapani Kulon</title>
                ...
                <nav
                    ...
                    <div class="container-fluid px-0">
                        <a class="navbar-brand font-weight-bolder ms-sm-3" href="{{ route('client.home') }}"
                            ...
                            @endforeach
                            &nbspRukun Warga 04 - Antapani Kulon
                        </a>
            ...
            <div class=" row">
                <div class="col-md-3 mb-4 ms-auto">
                    <div class="row">
                        ...
                        <div class="col-md-7 ">
                            <h6 class="font-weight-bolder text-md">Rukun Warga 04</h6>
                            <h6 class="font-weight-bolder text-sm mb-4">Kelurahan Antapani Kulon</h6>
                        </div>
                    </div>
                    <div>
                ...
                <div class="col-12">
                    <div class="text-center">
                        <p class="text-dark my-4 text-sm font-weight-normal">
                                    Rukun Warga 04 Kelurahan Antapani Kulon
                                </a></strong> | Copyright ©
                            <script>
